...
export default function CauseActionForm({
  ...
  const t = useTranslations("ActionForm");
        ...
        <div className="relative z-10 w-full max-w-2xl max-h-[90vh] overflow-y-auto rounded-[32px] border-[3px] border-dark bg-primary px-10 py-8">
          ...
          <section className="mt-6 space-y-4">
            <div className="flex items-center gap-3">
              <p className="text-2xl font-bold">{t("causeTitle")}</p>
              <Badge
                className={`${levelClasses[level]} border-3 border-dark rounded-2xl px-3 py-1 text-xs font-bold text-text`}
              >
                {levelLabel}
              </Badge>
          ...
          <section className="mt-4 space-y-2">
            <p className="text-2xl font-bold">{t("actionTitle")}</p>
            <p className="text-xs font-semibold">{metricLabel}</p>
